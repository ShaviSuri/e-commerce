        ...
        <div id="wrapper">
            <div id="content">
                    ...
                    <div class="container">
                        <div class="row logo-and-search">
                            <div class="col-sm-5 logo-col">
                                <a href="<?= base_url() ?>">
                                    <img style="width:80px;height:90px;" src="<?= base_url('attachments/site_logo/' . $sitelogo) ?>" class="site-logo" alt="<?= $_SERVER['HTTP_HOST'] ?>">
                                </a>
                            </div>
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="bag-info">
                                            <img style="width:45px;height:45px;" src="<?= base_url('template/imgs/white-bag.png') ?>" alt="Search">
                    ...
                    <nav class="navbar cloth">
                        <div class="container">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                ...
                                <li style="right:-317px;"><div class="user-panel">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?= LANG_URL . '/register' ?>" class="my-acc-register"><?= lang('register') ?></a>
                <?php } ?>
